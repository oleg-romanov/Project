...
def blob_process(img, threshold, detector):
    ...
    # for keypoint in keypoints:
        # print('keypoint: ' + str(keypoint.pt) + ';' + str(keypoint.pt))
    return keypoints
        ...
        if face_frame is not None:
            ...
            for eye in eyes:
                if eye is not None:
                    ...
                    keypoints = blob_process(eye, 41, detector)
                    eye = cv2.drawKeypoints(eye, keypoints, eye, (0, 0, 255), cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
                    # print(len(keypoints))
                    print(face_frame.width)
                    if len(keypoints) == 2:
                        print('================================')
                        x1 = keypoints[0].pt[0]
                        y1 = keypoints[0].pt[1]
                        ...
                        cv2.circle(eye, (center_x, center_y), 5, (255, 0, 0), -1)
